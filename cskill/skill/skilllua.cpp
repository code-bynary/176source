...
void LuaSkill::CONFIG::INIT()
{
	...
	FREE_SP = 0; //do not require spirit
	FREE_MONEY = 0; //do not require coins
	FREE_ITEM = 0; //do not require an item
}
...
void LuaSkill::SetFuncALLData()
{
	...
	REG_FUNC(GetValue                       );
	REG_FUNC(GetAmount                      );
	REG_FUNC(GetNewValue                    );
	REG_FUNC(GetNewValue2                   );
	REG_FUNC(GetNewValue3                   );
	REG_FUNC(GetNewValue4                   );
	REG_FUNC(GetNewValue5                   );
	REG_FUNC(GetNewValue6                   );
	REG_FUNC(GetNewValue7                   );
	REG_FUNC(GetRatioInt                    );
	REG_FUNC(GetValueInt                    );
	REG_FUNC(GetAmountInt                   );
	REG_FUNC(GetNewValueInt                 );
	REG_FUNC(GetNewValue2Int                );
	REG_FUNC(GetNewValue3Int                );
	REG_FUNC(GetNewValue4Int                );
	REG_FUNC(GetNewValue5Int                );
	REG_FUNC(GetNewValue6Int                );
	REG_FUNC(GetNewValue7Int                );
	...
	REG_FUNC(SetValue                       );
	REG_FUNC(SetAmount                      );
	REG_FUNC(SetNewValue                    );
	REG_FUNC(SetNewValue2                   );
	REG_FUNC(SetNewValue3                   );
	REG_FUNC(SetNewValue4                   );
	REG_FUNC(SetNewValue5                   );
	REG_FUNC(SetNewValue6                   );
	REG_FUNC(SetNewValue7                   );
	REG_FUNC(SetHp                          );
	REG_FUNC(SetMp                          );
	REG_FUNC(SetIncswim                     );
	REG_FUNC(SetIncgold                     );
...
double LuaSkill::GetNewValue                	(long long skill) { return skill ? ((Skill *)skill)->GetVictim()->GetNewValue               () : -0; }
double LuaSkill::GetNewValue2                	(long long skill) { return skill ? ((Skill *)skill)->GetVictim()->GetNewValue2              () : -0; }
double LuaSkill::GetNewValue3                	(long long skill) { return skill ? ((Skill *)skill)->GetVictim()->GetNewValue3              () : -0; }
double LuaSkill::GetNewValue4                	(long long skill) { return skill ? ((Skill *)skill)->GetVictim()->GetNewValue4              () : -0; }
double LuaSkill::GetNewValue5                	(long long skill) { return skill ? ((Skill *)skill)->GetVictim()->GetNewValue5              () : -0; }
double LuaSkill::GetNewValue6                	(long long skill) { return skill ? ((Skill *)skill)->GetVictim()->GetNewValue6              () : -0; }
double LuaSkill::GetNewValue7                	(long long skill) { return skill ? ((Skill *)skill)->GetVictim()->GetNewValue7              () : -0; }
...
double LuaSkill::GetNewValueInt                	(long long skill) { return skill ? ((Skill *)skill)->GetVictim()->GetNewValueInt            () : -0; }
double LuaSkill::GetNewValue2Int                (long long skill) { return skill ? ((Skill *)skill)->GetVictim()->GetNewValue2Int           () : -0; }
double LuaSkill::GetNewValue3Int                (long long skill) { return skill ? ((Skill *)skill)->GetVictim()->GetNewValue3Int           () : -0; }
double LuaSkill::GetNewValue4Int                (long long skill) { return skill ? ((Skill *)skill)->GetVictim()->GetNewValue4Int           () : -0; }
double LuaSkill::GetNewValue5Int                (long long skill) { return skill ? ((Skill *)skill)->GetVictim()->GetNewValue5Int           () : -0; }
double LuaSkill::GetNewValue6Int                (long long skill) { return skill ? ((Skill *)skill)->GetVictim()->GetNewValue6Int           () : -0; }
double LuaSkill::GetNewValue7Int                (long long skill) { return skill ? ((Skill *)skill)->GetVictim()->GetNewValue7Int           () : -0; }
...
double LuaSkill::SetNewValue                      	(long long skill, double value) { return skill ? ((Skill *)skill)->GetVictim()->SetNewValue   					(value) : -0; }
double LuaSkill::SetNewValue2                      	(long long skill, double value) { return skill ? ((Skill *)skill)->GetVictim()->SetNewValue2 					(value) : -0; }
double LuaSkill::SetNewValue3                     	(long long skill, double value) { return skill ? ((Skill *)skill)->GetVictim()->SetNewValue3					(value) : -0; }
double LuaSkill::SetNewValue4                     	(long long skill, double value) { return skill ? ((Skill *)skill)->GetVictim()->SetNewValue4 					(value) : -0; }
double LuaSkill::SetNewValue5                      	(long long skill, double value) { return skill ? ((Skill *)skill)->GetVictim()->SetNewValue5 					(value) : -0; }
double LuaSkill::SetNewValue6                      	(long long skill, double value) { return skill ? ((Skill *)skill)->GetVictim()->SetNewValue6 					(value) : -0; }
double LuaSkill::SetNewValue7                      	(long long skill, double value) { return skill ? ((Skill *)skill)->GetVictim()->SetNewValue7 					(value) : -0; }
