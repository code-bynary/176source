...
public:
	...
	int GetNPCid()		{ return object.GetNPCID(); }
	const XID& GetLeaderxId() { return object.GetLeaderID(); }
	int GetLeaderId()	{ return object.GetLeaderID().id; }
	const XID& GetCurTargetId()	{ return object.GetCurTargetID(); }
	const XID& GetTargetID() { return *target; }
	bool GetTargetIsSealed2() { return object.GetTargetIsSealed(object.GetCurTargetID()); }
	bool GetTargetIsStun2() { return object.GetTargetIsStun(object.GetCurTargetID()); }
	bool GetTargetIsSleep2() { return object.GetTargetIsSleep(object.GetCurTargetID()); }
	bool GetTargetIsRoot2() { return object.GetTargetIsRoot(object.GetCurTargetID()); }
	bool GetDebuffSeeker12() { return object.GetDebuffSeeker1(*target); }
	bool GetDebuffSeeker22() { return object.GetDebuffSeeker2(*target); }
	bool GetDebuffSeeker32() { return object.GetDebuffSeeker3(*target); }
	bool GetDebuffSeeker42() { return object.GetDebuffSeeker4(*target); }
	int GetSealMode() {	return object.GetSealMode2(); }
	int GetIdleMode2() { return object.GetIdleMode2(); }
	...
	int GetHighestLevel()      { return object.GetHighestLevel(); }
	...
	int GetCurweapon()  { return object.GetCurWeapon().weapon_class; }
	//int GetCountChargeMC()  { return object.GetCountChargeMerc(); }
	...
	int GetNewValue8Int()   { return (int)(newvalue8+0.00001f); }
	//int GetNewValue8Int()   { return (int)round(newvalue8); }
	//int GetNewValue8Int2() { return (int)ceil(newvalue8); }
...
public:
	...
	bool SetImmuneall2(bool b);
	bool SetImmuneallSK(bool b);
	...
	bool SetDecCooldownFeatureWith3SkillsID(bool);
	bool SetDecCooldownFeatureWith4SkillsID(bool);
	...
	bool SetShadowformDamage(bool b);
    bool SetFairyform(bool b);
	bool SetFairyformDamage(bool b);
	...
	bool SetCheckitem(int n, unsigned int c)    { return object.CheckItem(n,c); }
	
	bool SetRetort3(bool);
	bool SetElfLock(bool);
	bool SetFreecooldown(bool);
	bool SetFreecooldown2(bool);
	...
	// asn combo skill
	unsigned int GetChargeMerc();
	unsigned int CountChargeMerc();
	void GainChargeMerc( unsigned int val );
	void SpendChargeMerc( unsigned int val );
	// asn combo skill end
	...
	bool SetFilterDebuffSK4Dec(bool);
	...
	bool SetDeepenblessWF(bool);

	void SpendChargeMerc2(unsigned int val);
	bool SpendChargeMercWithProb(bool);

	bool SetGlyphComboSkill(bool b);

	bool SetGlyphComboSkillDec(bool b);

	void ConvertPlayerBalls(int mode);

	bool SetInchpstealFrenesi(bool);

	bool SetSlowWithStacks(bool b);

	bool SetRemoveSlowWithStacks(bool b);

	bool SetClearTwobuffRandom(bool b);

	bool SetClearOnebuffRandom(bool b);

	bool SetBeattackattachstateGotadeSangue(bool);
	bool SetBeattackattachstateEspiritoArruinado(bool);
	bool SetBeattackattachstateDesarmado(bool);
	bool SetBeattackattachstateOlhodoCeu(bool);

	bool SetResetCooldownFeature(bool);
	bool SetResetCooldownFeatureWith3SkillsID(bool);
	bool SetResetCooldownFeatureWith4SkillsID(bool);

	bool SetImmunneDirect(bool b);
	bool SetImmunneDirectforTower(bool b);

	bool SetImpairDamageAll(bool b);

	bool SetInchurtTM(bool);

	bool SetDechurtEPVerdant(bool);
	bool SetFixEPVerdant(bool);
	bool SetSealedEPVerdant(bool);
	bool SetFullChargeMercSecond(bool);
	bool SetDirecthurtForSiege(bool);

	bool SetIncfightproperty(bool);

	bool SetBleedingMordidaViolenta(bool);
	bool SetInvisibleDelayed(bool);

	bool SetPragaBless(bool);

	bool SetDecCooldownFeatureWith5SkillsID(bool);
	bool SetSoulbeatbackWf(bool);
	bool SetSoulbeatbackPaladin(bool);
	bool SetskillplusPAL(bool);
	...
	bool SetIncMoveClear(bool);
	bool SetForceTransform(bool);
	bool SetRenameCharacter(bool);
	...
	bool SetAddSpeedup(float inc);

	// Passe de Batalha 
	bool SetBattlePassEffect(bool);
	
	// N�vel de Genesis (G18)
	char GetGenesisLevelEnabled();

	// Nova Tw
	bool BuffRecvCataputeDamage(bool);

	// Novos filtros Lua > c++
	bool SetFilter14813(bool);
	bool SetFilter14918(bool);
	bool SendDuskLongJump(bool);

	// Reino do Norte
	bool SetDartCard(bool);
	bool SetDartCard2(bool);
