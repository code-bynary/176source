...
public:
	...
	static double GetNewValue                 	 (long long skill);
	static double GetNewValue2                 	 (long long skill);
	static double GetNewValue3                 	 (long long skill);
	static double GetNewValue4                 	 (long long skill);
	static double GetNewValue5                 	 (long long skill);
	static double GetNewValue6                	 (long long skill);
	static double GetNewValue7                 	 (long long skill);
	...
	static double GetNewValueInt              	 (long long skill);
	static double GetNewValue2Int              	 (long long skill);
	static double GetNewValue3Int              	 (long long skill);
	static double GetNewValue4Int             	 (long long skill);
	static double GetNewValue5Int              	 (long long skill);
	static double GetNewValue6Int              	 (long long skill);
	static double GetNewValue7Int              	 (long long skill);
	...
	static double SetNewValue                    (long long skill, double value);
	static double SetNewValue2                   (long long skill, double value);
	static double SetNewValue3                   (long long skill, double value);
	static double SetNewValue4                   (long long skill, double value);
	static double SetNewValue5                   (long long skill, double value);
	static double SetNewValue6                   (long long skill, double value);
	static double SetNewValue7                   (long long skill, double value);
