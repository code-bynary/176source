...
/*
47740  "4768 Skill 2"47741  "^ffffffImmunity to Slow

^ffcb4aCast　^ffffffInstant
^ffcb4aCooldown　^ffffff5.0　^ffcb4aseconds

^ffffffCan use the skill upon transforming in the New Year event.
Used on yourself to make you immune to be ^96f5ffSlowed^ffffff. Lasts ^96f5ff3^ffffff seconds."*/
