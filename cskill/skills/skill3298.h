...
/*
32980  "Entranced Dream"32981  "^ffffffEntranced Dream

^ffcb4aChannel　^ffffff30.0　^ffcb4a seconds

^ffcb4aRequired Cultivation  ^ffffffSpiritual Initiate

Raise your Spirit from ^96f5ff30^ffffff to ^96f5ff150^ffffff.
Lasts for ^96f5ff1^ffffff hour.

^a6caf0The benefits increase based on the number of Entranced Dreams equipped."*/
...
namespace GNET
{
    ...
    class Skill3298Stub:public SkillStub
    {
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount(skill->GetT0() > 199 ? 600 * ((0.1 * skill->GetT0()) / (skill->GetT0() + 60000)) + 120
            : 1800 * ((0.1 * skill->GetT0()) / (skill->GetT0() + 200)) + 30);
