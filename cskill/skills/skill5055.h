...
/*
50550  "唯Gilded Blaze "50551  "^ff5c00唯Gilded Blaze
銆€銆€銆€銆€銆€銆€銆€銆€銆€銆€銆€
^ffcb4aMana銆€^96f5ff209^ffffff
^ffcb4aChannel銆€^ffffffInstant
^ffcb4aCooldown銆€^ffffff20.0銆€^ffcb4asecond(s)
^ffcb4aWeapon銆€^ffffffFirearm, Unarmed
...
Increases the duration of the Ailment Immunity.
^ff0000LV1-4: Duration is increased to ^96f5ff3.0^ff0000 seconds.
^ff0000LV5-7: Duration is increased to ^96f5ff4.0^ff0000 seconds.
^ff0000LV8-9: Duration is increased to ^96f5ff5.0^ff0000 seconds.
^ff0000LV10: Duration is increased to ^96f5ff6.0^ff0000 seconds. @1@2
The immunity duration is increased to ^96f5ff%d^ff0000 seconds. @2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (_glyph_value + 2500);
