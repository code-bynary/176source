...
/*
37280  "Î¨Noxious Gas"37281  "^ff5c00Î¨Noxious Gas
...
^00ff00Lv1-4: Area increased to ^96f5ff12^00ff00 meters.
^00ff00Lv5-7: Area increased to ^96f5ff13^00ff00 meters.
^00ff00Lv8-9: Area increased to ^96f5ff14^00ff00 meters.
^00ff00Lv10: Area increased to ^96f5ff15^00ff00 meters.@1@2
^00ff00Area increased to ^96f5ff%d^00ff00 meters.@2"*/
...
namespace GNET
{
    ...
    class Skill728Stub:public SkillStub
    {
        ...
        Skill728Stub ():SkillStub (728)
        {
            cls                 = 127;
#ifdef _SKILL_CLIENT
            name                = L"ÎïÆ·¼¼ÄÜ-³ÖÐø»ØÑªÒ©¼Á";
            nativename          = "ÎïÆ·¼¼ÄÜ-³ÖÐø»ØÑªÒ©¼Á";
            icon                = "";
#endif
            max_level           = 5;
            type                = 4;
