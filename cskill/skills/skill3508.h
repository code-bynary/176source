...
/*
35080  "Î¨Stunning Arrow"35081  "^ff5c00Î¨Stunning Arrow
...
Stuns the target for ^96f5ff4 ^ffffffseconds.

^a6caf0Costs ^ffffff1 ^a6caf0unit of ammo.

^ff0000Sanguine Glyph Effect@1
^ff0000Lv1-4: Stuns the target for ^96f5ff4.5 ^ff0000seconds.
^ff0000Lv5-7: Stuns the target for ^96f5ff5.0 ^ff0000seconds.
^ff0000Lv8-9: Stuns the target for ^96f5ff5.5 ^ff0000seconds.
^ff0000Lv10: Stuns the target for ^96f5ff6.0 ^ff0000seconds.@1@2
Stuns the target for ^96f5ff%.1f ^ff0000seconds.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        {
            int _glyph_value = get_glyph((skill->GetLevel ()), 4700, 5200, 5800, 6100);
