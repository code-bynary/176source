...
/*
35020  "Î¨Aim Low"35021  "^ff5c00Î¨Aim Low
...
^ff0000Lv1-4: Silences the target for ^96f5ff2.0 ^ff0000seconds.
^ff0000Lv5-7: Silences the target for ^96f5ff2.5 ^ff0000seconds.
^ff0000Lv8-9: Silences the target for ^96f5ff3.0 ^ff0000seconds.
^ff0000Lv10: Silences the target for ^96f5ff3.5 ^ff0000seconds.@1@2
Silences the target for ^96f5ff%.1f ^ff0000seconds.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            int _glyph_value = get_glyph((skill->GetLevel ()), 2100, 3100, 3800, 4100);
