...
/*
56730  "Charred Dimension"56731  "^ffffffCharred Dimension　　　　　　　　　　Level %d
...
plus an additional ^96f5ff%d%%^ffffff of Fire damage.
Increases your skill damage by ^96f5ff%d%%^ffffff.
...
namespace GNET
{
    ...
    class Skill5673Stub:public SkillStub
    {
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * 100);
            skill->GetVictim ()->SetTime (1800000);
            skill->GetVictim ()->SetRatio (0.01 * skill->GetLevel () + 0.1);
