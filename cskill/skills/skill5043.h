...
/*
50430  "Î¨Murderous Indulgence"50431  "^ff5c00Î¨Murderous Indulgence

^ffcb4aRangeã€€^ffffffRanged
^ffcb4aManaã€€^96f5ff167^ffffff
^ffcb4aChannelã€€^ffffff0.1ã€€^ffcb4asecond
^ffcb4aCastã€€^ffffff3.0ã€€^ffcb4aseconds
^ffcb4aCharge Intervalã€€^ffffff45.0ã€€^ffcb4aseconds
...
Can be charged up twice, with an interval of ^96f5ff45^ffeaab seconds.
^ffeaabLV1-4: Deals an additional damage equal to ^96f5ff36%%^ffeaab of base Physical Attack.
^ffeaabLV5-7: Deals an additional damage equal to ^96f5ff54%%^ffeaab of base Physical Attack.
^ffeaabLV8-9: Deals an additional damage equal to ^96f5ff72%%^ffeaab of base Physical Attack.
^ffeaabLV10: Deals an additional damage equal to ^96f5ff90%%^ffeaab of base Physical Attack. @1@2
^ffeaabCan be charged up twice, increasing damage by ^96f5ff%d%%^ffeaab of base Physical Attack. @2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        class State3:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetSection (1);
                skill->SetDamage ((_glyph_value + 0.2) * skill->GetAttack ());
        ...
        class State4:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 0.36, 0.54, 0.72, 0.9);
                skill->SetSection (2);
                skill->SetDamage ((_glyph_value + 0.3) * skill->GetAttack ());
                skill->GetPlayer ()->SetPerform (0);
            }
            bool Interrupt (Skill * skill) const
            {
        ...
        class State6:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 0.36, 0.54, 0.72, 0.9);
                skill->SetSection (4);
                skill->SetDamage ((_glyph_value + 0.4) * skill->GetAttack ());
                skill->GetPlayer ()->SetPerform (0);
            }
            bool Interrupt (Skill * skill) const
            {
        ...
        class State10:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 0.36, 0.54, 0.72, 0.9);
                skill->SetSection (8);
                skill->SetDamage ((_glyph_value + 0.6) * skill->GetAttack ());
                skill->GetPlayer ()->SetPerform (0);
            }
            bool Interrupt (Skill * skill) const
            {
        ...
        class State11:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 0.36, 0.54, 0.72, 0.9);
                skill->SetSection (9);
                skill->SetDamage ((_glyph_value + 1) * skill->GetAttack ());
                skill->GetPlayer ()->SetPerform (0);
            }
            bool Interrupt (Skill * skill) const
            {
