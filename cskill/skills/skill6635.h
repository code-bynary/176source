...
/*
66350  "ΨHeavenly Chasm"66351  "^ff5c00ΨHeavenly Chasm　　　　　　　　　　　　
...
Deals ^96f5ff230%%^ffffff base physical damage plus ^96f5ff%d^ffffff to enemies
freezing them for ^96f5ff1^ffffff second.
...
double your Critical Rate to deal ^96f5ff1.5^fffffftimes damage.
...
^ffcb4aLv1-4: Deals an additional damage equal to ^96f5ff15%%^ffcb4a of base Attack
^ffcb4aLv5-7: Deals an additional damage equal to ^96f5ff20%%^ffcb4a of base Attack
^ffcb4aLv8-9: Deals an additional damage equal to ^96f5ff25%%^ffcb4a of base Attack
^ffcb4aLv10: Deals an additional damage equal to ^96f5ff30%%^ffcb4a of base Attack@1@2
Deals an additional damage equal to ^96f5ff%d%%^ffcb4a of base Attack@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue ((skill->GetPlayer ()->GetPureattack () + (2.5 + _glyph_value) * skill->GetPlayer ()->GetWeapondamage () + 13298) * skill->GetT2 () * 0.1 *
            (1 +
