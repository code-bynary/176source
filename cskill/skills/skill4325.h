...
/*
43250  "Double Health and Attack"43251  "^ff0000Î”Blessing of Immortality              Lv%d

^ffcb4aRangeã€€^96f5ff28^ffffffã€€^ffcb4a
^ffcb4aManaã€€^96f5ff450^ffffff
^ffcb4aChannelã€€^ffffff0.5  ^ffcb4aseconds
^ffcb4aCastã€€^ffffff1.0ã€€^ffcb4asecond
^ffcb4aCooldownã€€^ffffff300ã€€^ffcb4a seconds
^ffcb4aRequired Weapon:ã€€^ffffffUnarmed, Magic Instrument
^ffcb4aRequired Item:ã€€^96f5ffSubsiding Dirt^ffffff

^ffcb4aRequired Cultivationã€€^ffffffAware of Vacuity
Call upon the Pan Gu to bless your ally with everlasting life.
Double's the target's Max Health and fully heals them. Lasts ^96f5ff%d^ffffff seconds."*/
...
namespace GNET
{
    ...
    class Skill4325Stub:public SkillStub
    {
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (999999);
