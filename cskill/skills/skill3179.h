...
/*
31790  "Final: Wizard's Protection"31791  "Wizard Fire Immunity"*/
...
namespace GNET
{
    ...
    class Skill3179Stub:public SkillStub
    {
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPlayer ()->GetCls () == 1 ? 100 : skill->GetPlayer ()->GetCls () == 12 ? 100 : 0));
