...
/*
69160  "Î¨Seal of the God"69161  "^ff5c00Î¨Seal of the God

^ffcb4aRangeã€€^96f5ff%d^ffffffã€€^ffcb4ameters
^ffcb4aManaã€€^96f5ff%d^ffffff
^ffcb4aChannelã€€^ffffff1ã€€^ffcb4aseconds
...
^00ff00Lv1-4: Cooldown ^96f5ff120^00ff00 seconds.
^00ff00Lv5-7: Cooldown ^96f5ff100^00ff00 seconds.
^00ff00Lv8-9: Cooldown ^96f5ff80^00ff00 seconds.
^00ff00Lv10: Cooldown ^96f5ff60^00ff00 seconds.@1@2
Cast on friendly targets only.
Cooldown ^96f5ff%d^00ff00 seconds. @2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
...
#ifdef _SKILL_CLIENT
            name                = L"Éñ¡¤ÉñÖ®·âÓ¡";
            nativename          = "Éñ¡¤ÉñÖ®·âÓ¡";
            icon                = "ÉñÉñÖ®·âÓ¡ÂÌ.dds";
#endif
            max_level           = 1;
            type                = 2;
            apcost              = 100;
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetSealedEPVerdant (1);
            
            skill->GetVictim ()->SetProbability (1.0 * 100);
            skill->GetVictim ()->SetTime (15000);
            skill->GetVictim ()->SetShowicon (0);
            skill->GetVictim ()->SetValue (0);
            skill->GetVictim ()->SetFixEPVerdant (1);
            
            skill->GetVictim ()->SetProbability (1.0 * 100);
            skill->GetVictim ()->SetTime (15000);
            skill->GetVictim ()->SetRatio (0.9);
            skill->GetVictim ()->SetValue (0);
            skill->GetVictim ()->SetDechurtEPVerdant (1);
            return true;
        }
#endif
#ifdef _SKILL_SERVER
