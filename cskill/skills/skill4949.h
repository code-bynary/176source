...
/*
49490  "Murderous Indulgence"49491  "^ffffffMurderous Indulgenceã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€Level %d
...
^96f5ff%d%%^ffffff of your base Physical Attack.
...
namespace GNET
{
    ...
    class Skill4949Stub:public SkillStub
    {
        ...
        class State3:public SkillStub::State
        {
            ...
            {
                skill->SetSection (1);
                skill->SetDamage (0.1 * (skill->GetAttack () * (0.18 * skill->GetLevel () + 1.8)));
        ...
        class State10:public SkillStub::State
        {
            ...
            {
                skill->SetSection (8);
                skill->SetDamage (0.15 * (skill->GetAttack () * (0.18 * skill->GetLevel () + 1.8)));
                skill->GetPlayer ()->SetPerform (0);
            }
            bool Interrupt (Skill * skill) const
            {
