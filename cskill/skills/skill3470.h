...
/*
34700  "ΨSupercell"34701  "^ff5c00ΨSupercell
...
If you have ^96f5ff3 Ice Charges^00ff00, the initial Supercells paralyzes the target.
^00ff00Lv1-4: Paralyzes the target for ^96f5ff1^00ff00 seconds.
^00ff00Lv5-7: Paralyzes the target for ^96f5ff2^00ff00 seconds.
^00ff00Lv8-9: Paralyzes the target for ^96f5ff3^00ff00 seconds.
^00ff00Lv10: Paralyzes the target for ^96f5ff4^00ff00 seconds.@1@2
If you have ^96f5ff3 Ice Charges^00ff00, the initial Supercell paralyzes the target for ^96f5ff%d^00ff00 seconds.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            int _glyph_value = get_glyph(skill->GetT2 (), 1500, 2500, 3500, 4500);
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount(3470);
        ...
        {
            return (float) (player->GetSkilllevel (3470));
        }
#endif
#ifdef _SKILL_SERVER
