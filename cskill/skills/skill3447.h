...
/*
34470  "Î¨Ice Bullet"34471  "^ff5c00Î¨Ice Bulletã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€
...
^00ffffLv1-4: Disarms the target for ^ffffff1.5^00ffff seconds.
^00ffffLv5-7: Disarms the target for ^ffffff2.0^00ffff seconds.
^00ffffLv8-9: Disarms the target for ^ffffff2.5^00ffff seconds.
^00ffffLv10: Disarms the target for ^ffffff3.0^00ffff seconds.@1@2
^00ffffDisarms the target for ^ffffff%.1f^00ffff seconds.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            int _glyph_value = get_glyph(skill->GetT1(), 2000, 2500, 3000, 3500);
        ...
        {
            return (float) (player->GetSkilllevel (3447));
        }
#endif
#ifdef _SKILL_SERVER
