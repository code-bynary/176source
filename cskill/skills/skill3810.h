...
/*
38100  "ΨCursed Jail"38101  "^ff5c00ΨCursed Jail
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            //printf("skill3810: _charge_merc_count normal: val = %d \n", _charge_merc_count);
            // Remove as cargas
            /*skill->GetVictim ()->SetProbability (1.0 * (skill->GetSection () == 3 ? 100 : 0));
            skill->GetVictim ()->SetValue(_charge_merc_count);
            skill->GetPlayer ()->SpendChargeMercWithProb(1);	*/
            
            //skill->GetVictim ()->SetProbability (1.0 * (skill->GetSection () == 3 ? _charge_merc_count * 17 : 0));
            skill->GetVictim ()->SetProbability (1.0 * (_charge_merc_count > 0 ? (_charge_merc_count * 17) : 0));
