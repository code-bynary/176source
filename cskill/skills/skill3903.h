...
/*
39030  "Î¨Ocean's Edge"39031  "^ff5c00Î¨Ocean's Edge

^ffcb4aRangeã€€^ffffffMelee
^ffcb4aManaã€€^96f5ff%d^ffffff
^ffcb4aã€€^ffffff0.3ã€€^ffcb4aseconds
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        {
            int _glyph_value = get_glyph(skill->GetLevel (), 1800, 2300, 2700, 3400);
            ...
            */
            ...
            skill->GetVictim ()->SetTime (300 + _glyph_value); // 5 Segundos
            skill->GetVictim ()->SetFix (1);
