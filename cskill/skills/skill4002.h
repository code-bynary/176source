...
/*
40020  "Î¨Heartseeker"40021  "^ff5c00Î¨Heartseeker
...
Launch a projection of your weapon at a distant foe,
dealing base physical damage plus ^96f5ff200%%^ffffff of weapon damage
plus ^96f5ff5280^ffffff as Metal damage and stunning the target.

^ff0000Sanguine Glyph Effect:@1
^ff0000Lv1-4: Stuns the target for ^96f5ff1.0^ff0000 seconds.
^ff0000Lv5-7: Stuns the target for ^96f5ff1.5^ff0000 seconds.
^ff0000Lv8-9: Stuns the target for ^96f5ff2.0^ff0000 seconds.
^ff0000Lv10: Stuns the target for ^96f5ff2.5^ff0000 seconds.@1@2
^ff0000Stuns the target for ^96f5ff%.1f^ff0000 seconds.@2"*/
...
#ifdef _SKILL_CLIENT
            name                = L"Éñ¡¤ÈÛÐÄ½£Òâ";
            nativename          = "Éñ¡¤ÈÛÐÄ½£Òâ";
            icon                = "Éñ¡¤ÈÛÐÄ½£Òâºì.dds";
#endif
            max_level           = 1;
            type                = 1;
            apcost              = 0;
