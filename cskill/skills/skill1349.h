...
/*
13490  "Soul Shatter"13491  "^ffffffSoul Shatter  (Level %d)
...
^ffcb4aCooldownã€€^ffffff180.0  ^ffcb4a seconds
^ffcb4aChi Gainedã€€^ffffff10
^ffcb4aWeaponã€€^ffffffBlade or Sword

^ffcb4aRequired Cultivationã€€^ffffffTranscendent
Channel the power of the spirit world into a blast that
reduces your enemy's defenses, increasing the Critical
Rate of Fire and Earth skills against a non-player target
by ^96f5ff%d%%^ffffff, and the damage by ^96f5ff%d%%^ffffff, for ^96f5ff20^ffffff seconds.
