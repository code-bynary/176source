...
/*
40990  "Î¨Galemark"40991  "^ff5c00Î¨Galemark
...
^ffeaabLv1-4: Deals an additional ^96f5ff80%%^ffeaab of weapon damage while in Reaper Form.
^ffeaabLv5-7: Deals an additional ^96f5ff110%%^ffeaab of weapon damage while in Reaper Form.
^ffeaabLv8-9: Deals an additional ^96f5ff140%%^ffeaab of weapon damage while in Reaper Form.
^ffeaabLv10: Deals an additional ^96f5ff170%%^ffeaab of weapon damage while in Reaper Form.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        class State2:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (4270);
                skill->SetRatio (0.5 + (skill->GetPlayer ()->GetForm () == 1 ? _glyph_value : 0));
