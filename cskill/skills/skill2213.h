...
/*
22130  "Î©Life Hunter"22131  "^ffff00Î©Life Hunter
...
the target's Physical Defense by ^96f5ff40%% ^fffffffor ^96f5ff10 ^ffffffseconds.
The effect will not take effect when the target is a monster
and has a better Physical Defense reduction effect.


^d618e7Demon version also reduces Physical Defense by an additional ^96f5ff10%%^d618e7."*/
...
namespace GNET
{
    ...
    class Skill2213Stub:public SkillStub
    {
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (skill->GetPlayer ()->GetCls () == -1 ? 0 : 0.50);
