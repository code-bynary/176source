...
/*
41410  "Î¨Relentless Drift"41411  "^ff5c00Î¨Relentless Drift
...
^ffeaabLv1-4: Paralyzes the target for ^96f5ff0.5 ^ffeaabseconds
^ffeaabLv5-7: Paralyzes the target for ^96f5ff1.0 ^ffeaabsecond
^ffeaabLv8-9: Paralyzes the target for ^96f5ff1.5 ^ffeaabseconds
^ffeaabLv10: Paralyzes the target for ^96f5ff2.0 ^ffeaabseconds @1@2
While transformed, paralyzes the target for ^96f5ff%.1f ^ffeaabseconds.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * skill->GetPerformerCurForm() != 1 ? 100 : 0);
