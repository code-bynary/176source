...
/*
37220  "Î¨Redstone Venomworm"37221  "^ff5c00Î¨Redstone Venomworm
...
If the target is a player, it has a ^96f5ff25%% ^ffffffchance to reduce its
Defense to ^96f5ff0^ffffff. Lasts ^96f5ff10 ^ffffffseconds.

^a6caf0Costs ^ffffff1 ^a6caf0Sparks.

^00ff00Verdant Glyph Effect:@1
^00ff00LV1-4: Cooldown is reduced to ^96f5ff135 ^00ff00seconds.
^00ff00LV5-7: Cooldown is reduced to ^96f5ff120 ^00ff00seconds.
^00ff00LV8-9: Cooldown is reduced to ^96f5ff105 ^00ff00seconds.
^00ff00LV10: Cooldown is reduced to ^96f5ff90 ^00ff00seconds.@1@2
^00ff00Cooldown is reduced to ^96f5ff%d seconds.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        bool StateAttack (Skill * skill) const
        {
            // Def 0
            /*
            skill->GetVictim ()->SetProbability (1.0 * skill->GetTarget ()->GetCls () != 1 ? 25 : 0);
            skill->GetVictim ()->SetTime (11000);
            skill->GetVictim ()->SetRatio (1);
            skill->GetVictim ()->SetDecdefence (1);
            */
            
            skill->GetVictim ()->SetProbability (1.0 * skill->GetPlayer ()->GetCls () != -1 ? 25 : 0);
            skill->GetVictim ()->SetTime (11000);
