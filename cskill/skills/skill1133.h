...
/*
11330  "Earth Vector"11331  "^ffffffEarth Vector  (Level %d)
...
plus ^96f5ff%d%%^ffffff of weapon damage plus ^96f5ff%.1f^ffffff as Earth damage.
Has a ^96f5ff%d%%^ffffff chance to stun enemies for ^96f5ff%.1f^ffffff seconds.
