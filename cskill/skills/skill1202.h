...
/*
12020  "Spell Cutter"12021  "^ffffffSpell Cutter  (Level %d)

^ffcb4aCast Range ã€€^ffffffMelee
^ffcb4aCost Manaã€€^96f5ff180^ffffff
^ffcb4aChanneling Timeã€€^ffffff0.5ã€€^ffcb4a seconds
...
Slash at your foe with a strike that inhibits magic. Deals base physical
damage plus ^96f5ff3834.1^ffffff and interrupts the target's channeling. Dampens the
target's spellcasting powers for ^96f5ff3^ffffff seconds, increasing channeling time by ^96f5ff30%%^ffffff."*/
