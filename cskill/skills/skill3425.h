...
/*
34250  "Î¨Cloudburst"34251  "^ff5c00Î¨Cloudburstã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€
...
Reduces the target's Elemental Resistances by up to ^96f5ff60%%^ffffff based on
the number of Thunder Charges, for ^96f5ff10^ffffff seconds. Generates a Thunder Charge.
Elemental Resistances are reduced by ^96f5ff45%%^ffffff to ^96f5ff60%%^ffffff.
^96f5ffWhile in Reaper Form, damage is increased by ^ffffff33%%.

^ffa4a9Can be cast while moving.

^ffeaabArgent Glyph Effect:@1
^ffeaabLv1-4: While in Reaper Form, damage is increased by ^96f5ff45%%.
^ffeaabLv5-7: While in Reaper Form, damage is increased by ^96f5ff50%%.
^ffeaabLv8-9: While in Reaper Form, damage is increased by ^96f5ff55%%.
^ffeaabLv10: While in Reaper Form, damage is increased by ^96f5ff60%%.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        class State2:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 1.45, 1.5, 1.55, 1.6);
                
                skill->GetPlayer ()->SetDecmp (178);
                skill->SetPlus (5887);
                skill->SetRatio (1.7/* + (skill->GetPlayer ()->GetForm () == 1 ? _glyph_value : 0)*/);
                skill->GetPlayer ()->SetAddball (5);
                skill->SetGolddamage ((skill->GetPlayer ()->GetForm () == 1 ? _glyph_value : 0.9) * skill->GetMagicattack ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (skill->GetPerformerCurBalls () == 15 ? 0.45 : (skill->GetPerformerCurBalls () == 11 ? 0.37 : (skill->GetPerformerCurBalls () == 7 ? 0.33 : 0.3)));
