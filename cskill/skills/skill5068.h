...
/*
50680  "Trap Stealth"50681  "Technician Device Only; Stealth for 30 seconds 5 seconds after spawn"*/
...
namespace GNET
{
    ...
    class Skill5068Stub:public SkillStub
    {
        ...
        {
            printf ("skill5068: StateAttack \n");
            skill->GetVictim ()->SetProbability(1.0 * 100);
            skill->GetVictim ()->SetTime(31000);
            skill->GetVictim ()->SetInvisibleDelayed(1);
