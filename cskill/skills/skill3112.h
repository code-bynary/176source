...
/*
31120  "Final: Mountain's Seize"31121  "Mountain's Seize released by Wizard monsters."*/
...
namespace GNET
{
    ...
    class Skill3112Stub:public SkillStub
    {
        ...
        {
            return (float) ((skill->GetLevel () * 0.4) + 8);
        }
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * skill->GetLevel() + 85);
