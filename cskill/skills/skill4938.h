...
/*
49380  "Flame: Deadly Flow"49381  "^ffffffFlame: Deadly Flowã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€Level %d
...
dealing Physical Damage to it as well as all enemy targets within ^96f5ff%.1f^ffffff meters
by base Physical Attack plus ^96f5ff%.1f^ffffff. For each additional enemy within
the effect range, the caster gains ^96f5ff1^ffffff Chi. "*/
    ...
    class Skill4938Stub:public SkillStub
    {
        ...
        class State2:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetRatio (0);*/
                skill->SetPlus (5.1 * skill->GetLevel() * skill->GetLevel() + 104.2 * skill->GetLevel() + 236.6);
        ...
        {
            return (float) (5 + skill->GetPlayer ()->GetRange () + 4.4 + 0.4 * skill->GetLevel ());
        }
#endif
#ifdef _SKILL_SERVER
