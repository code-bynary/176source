...
/*
25850  "Churning Vortex"25851  "^ffffffChurning Vortex (Level %d)
...
^ffcb4aCooldownã€€^ffffff%.1f^ffcb4aã€€seconds
^ffcb4aWeaponã€€^ffffff Scythe, Unarmed

^ffcb4aRequired Cultivationã€€^ffffffTranscendent
Summon a furious whirlwind near your target, pulling all
enemies within ^96f5ff12^ffffff meters to the center of the vortex
every ^96f5ff3^ffffff seconds. Last ^96f5ff12^ffffff seconds. Generates an Ice Charge.
