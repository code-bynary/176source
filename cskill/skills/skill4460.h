...
/*
44600  "ΨShadow Teleport"44601  "^ff5c00ΨShadow Teleport
...
Reduces the cooldown by ^ffffff15^00ffff seconds per Hit Charge.
^00ffffLv1-4: Generates ^ffffff20^00ffff Chi after use.
^00ffffLv5-7: Generates ^ffffff30^00ffff Chi after use.
^00ffffLv8-9: Generates ^ffffff40^00ffff Chi after use.
^00ffffLv10: Generates ^ffffff50^00ffff Chi after use.@1@2
Reduces the cooldown by ^ffffff15^00ffff seconds per Hit Charge.
Generates ^ffffff%d^00ffff Chi after use.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        class State2:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                ...
                //float _charge_merc_count = skill->GetPlayer()->CountChargeMerc();
