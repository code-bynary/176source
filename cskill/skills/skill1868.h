...
namespace GNET
{
    ...
    class Skill1868Stub:public SkillStub
    {
        ...
        {
            skill->GetVictim ()->SetValue (skill->GetT1 () * //calcula o dano
            skill->GetT2 () * 0.1 * // calcula o critico
            (1 + 0.01 * (skill->GetT0 () - skill->GetPlayer ()->GetDefenddegree () > 0 ? skill->GetT0 () - skill->GetPlayer ()->GetDefenddegree () : 0))); //dano baseado no nv de ataque
