...
/*
65950  "ΨGathering Cloud"65951  "^ff5c00ΨGathering Cloud　　　　　　　　　　　　
...
damage plus ^96f5ff%d^ffffff to enemies . If the target is under the status of
...
only walk within ^96f5ff5^ffffff meters. Lasts for ^96f5ff15^ffffff seconds. Restores ^96f5ff20 ^ffffffChi after casting.
...
^00ffffLv10 : Restores ^ffffff100 Chi@1@2
^00ffffRestores ^ffffff%d Chi^00ffff@2
"*/
