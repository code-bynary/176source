...
/*
18790  "N/A天极净�?"18791  "^ffffffMeteor Shower　　　　　　　　

^ffcb4aRange　^ffffff10　^ffcb4ameters
^ffcb4aChannel　^ffffff1.0　^ffcb4aseconds
^ffcb4aCast　^ffffff1.0　^ffcb4aseconds
^ffcb4aCooldown　^ffffff18.0　^ffcb4aseconds^ffffff

Rain meteors on enemies within 5 meters of the target,
causing physical damage equal to twice the Angels' physical attack.
^96f5ff90%%^ffffff chance to stun for ^96f5ff%.1f^ffffff seconds, based on your Soulforce.
"*/
