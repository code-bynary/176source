...
/*
34600  "Î¨Frigid Thunder"34601  "^ff5c00Î¨Frigid Thunder
...
Freezes the target if you have ^96f5ff1 Thunder Charge and 2 Ice Charges^ff0000.
^ff0000Lv1-4: Freezes the target for ^96f5ff3.1^ff0000 seconds.
^ff0000Lv5-7: Freezes the target for ^96f5ff3.4^ff0000 seconds.
^ff0000Lv8-9: Freezes the target for ^96f5ff3.7^ff0000 seconds.
^ff0000Lv10: Freezes the target for ^96f5ff4^ff0000 seconds.@1@2
If you have ^96f5ff1 Thunder Charge and 2 Ice Charges^ff0000, freezes the target for ^96f5ff%.1f^ff0000 seconds.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        {
            int _glyph_value = get_glyph(skill->GetLevel (), 3500, 3800, 3900, 4200);
            // printf("skill->GetPerformerCurBalls() %d \n", skill->GetPerformerCurBalls());
            // printf("skill->GetPerformerCurBalls() %d \n", skill->GetT0());
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetPerformerCurBalls() == 7 ? 100 : 70));
            skill->GetVictim ()->SetTime (skill->GetPerformerCurBalls() == 7 ? _glyph_value : 3100);
