...
/*
33200  "Transform into Seclusive Painter Yolan"33201  "At level 1, the status lasts for 1 minute.
At level 10, transformation is removed."*/
...
namespace GNET
{
    ...
    class Skill3320Stub:public SkillStub
    {
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (skill->GetLevel() == 10 ? -2 : 54);
