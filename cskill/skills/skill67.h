...
/*
670  "Glacial Spike"671  "^ffffffGlacial Spike  (Level %d)

^ffcb4aRange　^96f5ff10 ^ffffff ^ffcb4ameters
...
Focus cold magic into a ^96f5ff12^ffffff-meter burst of glacial spikes, dealing base
physical damage plus ^96f5ff%d%%^ffffff of weapon damage
plus ^96f5ff%.1f^ffffff. Reduces all targets'
Physical and Magical Defenses by ^96f5ff%d%%^ffffff.
