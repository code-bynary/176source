...
/*
29000  "Î©Constellation Arc"29001  "^ffff00Î©Constellation Arc
...
^ffcb4aRequired Weaponã€€^ffffffSaber
...
from gear by ^96f5ff40%%^ffffff for ^96f5ff7^ffffff seconds. If the target is a
player, Physical Defense will instead be reduced by ^96f5ff60%%^ffffff.
...
^d618e7Demon version reduces Physical Defense by ^96f5ff60%%^d618e7,
^d618e7and reduces players' Physical Defense by ^96f5ff90%%^d618e7."*/
