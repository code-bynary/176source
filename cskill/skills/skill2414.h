...
/*
24140  "Î¦Great Cyclone"24141  "^ffff00Î¦Great Cyclone
...
^96f5ff5266^ffffff. Reduces the enemy's speed by ^96f5ff40%%^ffffff for ^96f5ff8^ffffff seconds.

^f7dfa5Has no cooldown while using Violet Dance.

Sage version increases the speed reduction to ^96f5ff50%%^f7dfa5, and the duration to ^96f5ff2^f7dfa5 seconds."*/
