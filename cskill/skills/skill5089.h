...
/*
50890  "Darkverse: Heart Break"50891  "^ffffffDarkverse: Heart Break                 Lv%d
...
^ffcb4aRequired Cultivationã€€ã€€^ffffffSpiritual Initiate
The first move of the Darkverse form.
Increases the Physical Attack gained from your gear by ^96f5ff%d%%^ffffff,
and changes all damage taken into physical damage. Lasts ^96f5ff%d^ffffff minutes.
...
namespace GNET
{
    ...
    class Skill5089Stub:public SkillStub
    {
        ...
        Skill5089Stub ():SkillStub (5089)
        {
            cls                 = 13;
#ifdef _SKILL_CLIENT
            name                = L"Çãµ¹Ðþ»Æ-ËéÐÄ";
            nativename          = "Çãµ¹Ðþ»Æ-ËéÐÄ";
            icon                = "Çãµ¹Ðþ»ÆËéÐÄ.dds";
#endif
            max_level           = 10;
            type                = 2;
            apcost              = 0;
