...
/*
25800  "Ice Bullet"25801  "^ffffffIce Bullet (Level %d)
...
enemy, dealing ^96f5ff90%%^ffffff of base magic damage plus ^96f5ff%.1f%%^ffffff
of weapon damage plus ^96f5ff%.1f^ffffff as Water damage.
Stuns the target for up to ^96f5ff5^ffffff seconds, based on
