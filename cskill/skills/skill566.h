...
/*
5660  "â—Magic Shell"5661  "^8080ffâ—Magic Shell
...
Shield your ally with divine magic, increasing the
Magic Defense of the target's equipment by ^96f5ff%d%%^ffffff for ^96f5ff60^ffffff minutes.

^f7dfa5Sage version temporally enhances the target for ^96f5ff10^f7dfa5 seconds, increasing channeling speed by ^96f5ff20%%^f7dfa5."*/
