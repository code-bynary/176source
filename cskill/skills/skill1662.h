...
/*
16620  "â—Cragglord"16621  "^8080ffâ—Cragglordã€€ã€€ã€€ã€€ã€€ã€€ã€€

^ffcb4aManaã€€^96f5ff1560^ffffff
...
and physical damage, but only lasts ^96f5ff20^ffffff seconds.

^a6caf0You can use Transference to increase the duration of the Cragglord.
^a6caf0Energy Leech is not effective.
...
#ifdef _SKILL_CLIENT
            name                = L"Õæ¡¤ÔÖÐÇ½µÁÙ";
            nativename          = "Õæ¡¤ÔÖÐÇ½µÁÙ";
            icon                = "»ðÉñÏÂ½çÏÉ¼¼ÄÜ.dds";
#endif
            max_level           = 1;
            type                = 2;
            apcost              = 200;
