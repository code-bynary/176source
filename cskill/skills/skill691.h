...
/*
36910  "Î¨Frozen Flame"36911  "^ff5c00Î¨Frozen Flame
...
^ffcb4aLv5-7: Deals an additional^96f5ff110%%^ffcb4a of weapon damage
^ffcb4aLv8-9: Deals an additional^96f5ff140%%^ffcb4a of weapon damage
^ffcb4a Lv10 : Deals an additional^96f5ff170%%^ffcb4a of weapon damage@1@2
...
namespace GNET
{
    ...
    class Skill691Stub:public SkillStub
    {
        ...
        Skill691Stub ():SkillStub (691)
        {
            cls                 = 127;
#ifdef _SKILL_CLIENT
            name                = L"2¼¶³ÇÕ½BOSS1¼¼ÄÜ";
            nativename          = "2¼¶³ÇÕ½BOSS1¼¼ÄÜ";
            icon                = "";
#endif
            max_level           = 5;
            type                = 2;
