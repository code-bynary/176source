...
/*
29770  "Single-target tower attack"29771  "Magical attack with no elemental nature, directly damage target's HP"*/
...
namespace GNET
{
    ...
    class Skill2977Stub:public SkillStub
    {
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * skill->GetPlayer()->GetLevel()==149 ? 100 : 0);
