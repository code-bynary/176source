    ...
    class Skill3217Stub:public SkillStub
    {
        ...
        class State3:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus(8242);
                skill->SetRatio(8.5);
                skill->SetWooddamage(skill->GetMagicattack() * 0.4);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * skill->GetLevel() == 2 ? (skill->GetSection () == 1 ? 100 : 0) : 0);
            skill->GetVictim ()->SetTime (6000);
            skill->GetVictim ()->SetDizzy (1);
            
            
            skill->GetVictim ()->SetProbability (1.0 * skill->GetLevel() == 2 ? (skill->GetSection () == 2 ? 100 : 0) : 0);
            skill->GetVictim ()->SetTime (6000);
            skill->GetVictim ()->SetRatio (0.3);
            skill->GetVictim ()->SetInchurt (1);
            
            skill->GetVictim ()->SetProbability (1.0 * skill->GetLevel() == 2 ? (skill->GetSection () == 3 ? 100 : 0) : 0);
            skill->GetVictim ()->SetValue (-100);
            skill->GetVictim ()->SetAp (1);
            
            skill->GetVictim ()->SetProbability (1.0 * skill->GetLevel() == 2 ? (skill->GetSection () == 4 ? 100 : 0) : 0);
            skill->GetVictim ()->SetTime (6000);
            skill->GetVictim ()->SetRatio (1);
            skill->GetVictim ()->SetDecresist (1);
            
            skill->GetVictim ()->SetProbability (1.0 * skill->GetLevel() == 2 ? (skill->GetSection () == 5 ? 100 : 0) : 0);
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue(skill->GetLevel() == 2 ?  skill->GetSection() + 49658 : 0);
