...
/*
40030  "Î¨Heartseeker"40031  "^ff5c00Î¨Heartseeker
...
foe, dealing base physical damage plus ^96f5ff200%%^ffffff
of weapon damage plus ^96f5ff5280^ffffff as Metal damage.
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        class State2:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (5280);
                skill->SetRatio (2.0 + _glyph_value);
