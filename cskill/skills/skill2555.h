...
/*
25550  "Divine Moonlight"25551  "^ffffffDivine Moonlight (Level %d)

^ffcb4aRangeã€€^ffffff20ã€€^ffcb4ameters
...
Bathe the target in divine moonlight, putting it to sleep for ^96f5ff5^ffffff seconds.
Also burns the target with radiance for ^96f5ff5^ffffff seconds, dealing ^96f5ff%.1f^ffffff Earth damage.
