...
/*
62280  "Î¦ Alacrity of the Beast"62281  "^ffff00Î¦Alacrity of the Beast
...
^f7dfa5Deals an additional ^96f5ff800^f7dfa5 damage."*/
...
namespace GNET
{
    ...
    class Skill6228Stub:public SkillStub
    {
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (800 + 2694 + skill->GetT0());
