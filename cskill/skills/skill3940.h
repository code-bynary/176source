...
/*
39400  "Î¨Glacial Spike"39401  "^ff5c00Î¨Glacial Spike
...
^00ffffLv1-4: In ^ffffff6^00ffff seconds, the damage of the next ^ffffffÎ¨Myriad Sword Stance^00ffff is increased by ^ffffff20%%.
^00ffffLv5-7: In ^ffffff6^00ffffseconds, the damage of the next ^ffffffÎ¨Myriad Sword Stance^00ffff is increased by ^ffffff30is %%.
^00ffffLv8-9: In ^ffffff6^00ffffseconds, the damage of the next ^ffffffÎ¨Myriad Sword Stance^00ffff is increased by ^ffffff40%%.
^00ffff Lv10: In^ffffff6^00ffffseconds, the damage of the next ^ffffffÎ¨Myriad Sword Stance^00ffff is increased by ^ffffff50%%.@1@2
^00ffff In^ffffff6^00ffffseconds, the damage of the next ^ffffffÎ¨Myriad Sword Stance^00ffff is increased by ^ffffff%d%%.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        {
            return (float) (16 + skill->GetPlayer ()->GetRange ());
        }
#ifdef _SKILL_CLIENT
