...
/*
26530  "Unable to select Shadow Image"26531  "^ffffffOverload (Level %d)

^ffcb4aChannelã€€^ffffff0.1ã€€^ffcb4aseconds
^ffcb4aCastã€€^ffffff0.1ã€€^ffcb4aseconds
^ffcb4aCooldownã€€^ffffff10ã€€^ffcb4aseconds

^ffffffGives your basic attacks a ^96f5ff30%%^ffffff chance to increase the target's
cooldowns by ^96f5ff%d%%^ffffff for ^96f5ff4^ffffff seconds. Less effective on non-player targets."*/
