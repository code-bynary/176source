...
/*
22570  "Î©Pyroshell"22571  "^ffff00Î©Pyroshell
...
Rate by ^96f5ff15%%^ffffff, and Health regeneration by ^96f5ff15^ffffff
per second. Lasts for ^96f5ff15^ffffff minutes.

^a6caf0Only one elemental shell can be activated at a time.

^d618e7Demon version increases Health regeneration by ^96f5ff15^d618e7 per second."*/
