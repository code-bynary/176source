...
/*
28970  "Sonic Boom"28971  "^ffffffSonic Boom

^ffcb4aCostã€€^96f5ff%d^ffffff
^ffcb4aChannelã€€^ffffff1.2ã€€^ffcb4a seconds
^ffcb4aCastã€€^ffffff0.8ã€€^ffcb4a seconds
^ffcb4aCooldownã€€^ffffff1.0ã€€^ffcb4a seconds^ffffff

Deals Metal damage that is 8 times of your base magic attack to target."*/
