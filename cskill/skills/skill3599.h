...
/*
35990  "Î¨Earth Vector"35991  "^ff5c00Î¨Earth Vector
...
Deals additional damage to silenced targets.
^ffeaabLv1-4: Deals an additional ^96f5ff8%%^ffeaab damage to silenced targets
^ffeaabLv5-7: Deals an additional ^96f5ff12%%^ffeaab damage to silenced targets
^ffeaabLv8-9: Deals an additional ^96f5ff16%%^ffeaab damage to silenced targets
^ffeaab Lv10: Deals an additional ^96f5ff20%%^ffeaab damage to silenced targets@1@2
Deals an additional
^96f5ff%d%%^ffeaab damage to silenced targets@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        class State2:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (3987);
                skill->SetRatio (2);
                //printf("skill: 3599 -> GetTargetIsSealed() ->>>> %d \n",skill->GetTarget ()->GetTargetIsSealed ());
                skill->SetEarthdamage (skill->GetMagicattack () + (skill->GetTarget ()->GetTargetIsSealed () ? skill->GetMagicattack () * _glyph_value : 0));
