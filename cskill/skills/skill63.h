...
/*
630  "Drake's Breath Bash"631  "^ffffffDrake's Breath Bash  (Level %d)
...
into all enemies in a ^96f5ff%.1f^ffffff meter line. Deals base
physical damage plus ^96f5ff%d%%^ffffff of weapon damage plus ^96f5ff%.1f^ffffff.
For the next 15 seconds, all your normal attacks deal
extra fire damage equal to ^96f5ff%d%%^ffffff of your weapon damage.
