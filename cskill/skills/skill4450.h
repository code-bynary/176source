...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        class State2:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (3046);
                //skill->SetRatio (skill->GetCharging () >= 1500 ? 0.3 + _glyph_value  : 0);
                //skill->SetDamage (skill->GetAttack ());
                //skill->SetDamage(skill->GetAttack () + (skill->GetCharging () >= 1500 ? _glyph_value * skill->GetAttack () : 0));
                skill->SetDamage(skill->GetCharging () >= 1500 ? _glyph_value * skill->GetAttack () : 0.2 * skill->GetAttack ());
