...
/*
10490  "Faith"10491  "^ffffffFaith　　　　　　　　　　　　　LV%d

^ffcb4aEnergy　^96f5ff160^ffffff
^ffcb4aStamina　^96f5ff500^ffffff
^ffcb4aInstant
^ffcb4aCooldown　^ffffff60　^ffcb4a second
^ffcb4aRequisite Class　^ffffffAll

Has a 10%% chance per skill level to become immune to all
negative status effects for 5 seconds.
(Available when you have more than 160 Energy.)

^ffa083Strength: Every 5 Genie Strength points reduces the energy cost by 1."*/
