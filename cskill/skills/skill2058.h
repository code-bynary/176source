...
/*
20580  "Ghost"20581  "^ffffffGhostã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€Level %d

^ffcb4aChannelã€€^ffffff0.1^ffcb4aseconds
^ffcb4aCastã€€^ffffff0.1ã€€^ffcb4aseconds
^ffcb4aCooldownã€€^ffffff10ã€€^ffcb4aseconds
^ffffffDamage from players is reduced by ^96f5ff%d%%^ffffff."*/
...
namespace GNET
{
    ...
    class Skill2058Stub:public SkillStub
    {
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (0.25 + 0.05 * 6);
