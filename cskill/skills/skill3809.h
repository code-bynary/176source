...
/*
38090  "ΨCursed Jail"38091  "^ff5c00ΨCursed Jail
...
precision attacks, stunning the target for ^96f5ff6 ^ffffffseconds
and dealing ^96f5ff50%% ^ffffffof base physical damage. Slows the target
for ^96f5ff10 ^ffffffseconds, reducing speed by ^96f5ff60%%^ffffff. Base skill
damage is equal to ^96f5ff375%% ^ffffffof weapon damage plus ^96f5ff7497^ffffff.

^a6caf0Costs ^ffffff2 ^a6caf0Spark ^a6caf0and ^ffffff50 ^a6caf0Chi.
...
Paralyzes the target for ^96f5ff1 ^ff0000second per Hit Charge.
^ff0000Lv1-4: Deals ^96f5ff60%% ^ff0000of base skill damage.
^ff0000Lv5-7: Deals ^96f5ff65%% ^ff0000of base skill damage.
^ff0000Lv8-9: Deals ^96f5ff70%% ^ff0000of base skill damage.
^ff0000Lv10: Deals ^96f5ff75%% ^ff0000of base skill damage.@1@2
Paralyzes the target for ^96f5ff1 ^ff0000second per Hit Charge.
Deals ^96f5ff%d%% ^ff0000of base skill damage.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            //printf("skill3809: _charge_merc_count normal: val = %d \n", _charge_merc_count);
            
            skill->GetVictim ()->SetProbability (1.0 * _charge_merc_count > 0 ? 100 : 0);
            skill->GetVictim ()->SetTime (1000 * _charge_merc_count);
            ...
            // Remove as cargas
            // skill->GetPlayer ()->SpendChargeMerc2(_charge_merc_count);
