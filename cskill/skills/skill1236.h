...
/*
12360  "â—Glacial Shards"12361  "^8080ffâ—Glacial Shards
...
Has a ^96f5ff60%%^ffffff chance to freeze targets for ^96f5ff6^ffffff seconds.

^f7dfa5Sage version increases the freeze duration to ^96f5ff6^f7dfa5 seconds."*/
...
#ifdef _SKILL_CLIENT
            name                = L"Õæ¡¤ÀäÄýÊõ";
            nativename          = "Õæ¡¤ÀäÄýÊõ";
            icon                = "ÀäÄýÊõÏÉ¼¼ÄÜ.dds";
#endif
            max_level           = 1;
            type                = 1;
            apcost              = 0;
