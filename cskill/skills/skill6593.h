...
/*
65930  "ΨGathering Cloud"65931  "^ff5c00ΨGathering Cloud　　　　　　　　　　　　
...
damage plus ^96f5ff%d^ffffff to enemies . Consumes all Marks
of Wind, Forest, Fire, or Mountain to increase effectiveness
and adds the effect of ^96f5ff1^ffffff more mark for targets with all marks.
Coils targets for ^96f5ff3^ffffff for every mark consumed and
they will not be able to use Reposition
and can only walk within ^96f5ff5^ffffff meters.
