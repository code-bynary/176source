...
/*
31950  "Î©Roar of the Pride"31951  "^ffff00Î©Roar of the Pride
...
namespace GNET
{
    ...
    class Skill3195Stub:public SkillStub
    {
        ...
        {
            //printf("Curweapon: id = %d \n", skill->GetTarget()->GetId() );
            ...
            skill->GetVictim ()->SetTime (skill->GetPerformerCurWeapon () == 5 ? 6000 : 8000);
            ...
            // Dano
            //skill->GetVictim ()->SetValue ((int)skill->GetT2 () != 1 ? 0 : (skill->GetT1 () * (skill->GetT0 () * 2) * 0.001));
            //skill->GetVictim ()->SetPhysichurt ((int)skill->GetT2 () != 1 ? 0 : 1);
            return true;
        }
#endif
#ifdef _SKILL_SERVER
        ...
        {
            return (float) ((2 * player->GetPureattack ()) * (player->GetRand () < player->GetCrit () * 2 ? 1.5 : 1));
        }
#endif
#ifdef _SKILL_SERVER
    ...
    {
        return (float) (skill->GetPlayer ()->GetCurWeapon() != 5 ? 10 : 22);
    }
#endif
#ifdef _SKILL_SERVER
