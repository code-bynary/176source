...
/*
63610  "¦² Blinding Blaze "
63611  "^ffff00 ¦² Blinding Blaze

^ffcb4aRange¡¡^96f5ff30^ffffff¡¡^ffcb4ameters
^ffcb4aMana¡¡^96f5ff909
...
Curse the target with arcane fire. When attacked,
the target has a chance to be immobilized for ^96f5ff3^ffffff s.
This effect can only be triggered once every ^96f5ff10^ffffff seconds.
The curse lasts for ^96f5ff45^ffffffseconds.
*/
