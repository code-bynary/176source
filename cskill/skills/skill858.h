...
/*
38580  "Î¨Berserker's Wrath"38581  "^ff5c00Î¨Berserker's Wrath
...
^ffeaabLv1-4: Cooldown reduced to ^96f5ff54^ffeaab seconds.
^ffeaabLv5-7: Cooldown reduced to ^96f5ff51^ffeaab seconds.
^ffeaabLv8-9: Cooldown reduced to ^96f5ff48^ffeaab seconds.
...
namespace GNET
{
    ...
    class Skill858Stub:public SkillStub
    {
        ...
        Skill858Stub ():SkillStub (858)
        {
            cls                 = 127;
#ifdef _SKILL_CLIENT
            name                = L"ÍÁÏµÈºÌå³ÖÐøÄ§ÉË";
            nativename          = "ÍÁÏµÈºÌå³ÖÐøÄ§ÉË";
            icon                = "";
#endif
            max_level           = 10;
            type                = 3;
