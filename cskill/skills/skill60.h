...
/*
600  "Vacuous Palm"601  "^ffffffVacuous Palm  (Level %d)
...
reducing their speed. Deals base physical damage plus ^96f5ff%.1f^ffffff
and slows the target for ^96f5ff8^ffffff seconds, decreasing its speed by ^96f5ff%d%%^ffffff.
