...
/*
27700  "●Eternity"27701  "^8080ff●Eternity
...
Plunge your blade into the ground, generating a shockwave
that hits all enemies within ^96f5ff10^ffffff meters. Deals base physical
damage plus ^96f5ff70%%^ffffff of weapon damage plus ^96f5ff6967^ffffff and increases your
speed by ^96f5ff30%%^ffffff for ^96f5ff3^ffffff seconds. Has a ^96f5ff50%%^ffffff chance to stun the enemy
for ^96f5ff2^ffffff seconds. Otherwise, immobilizes the enemy for ^96f5ff2^ffffff seconds.


^ffa4a9Combo Skill: Default hotkey ^59EE4CR
^ffa4a9Required Skill: ^59EE4CGalemark

Sage version increases the chance to evade damage for ^96f5ff5^f7dfa5 seconds by ^96f5ff30%%^f7dfa5 .
