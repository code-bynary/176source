...
/*
56600  "Î¦Storm Mistress"56601  "^ffff00Î¦Storm Mistressã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€Lv %d
...
^ffcb4aWeaponã€€^ffffffUnarmed, Wand

^ffcb4aRequired Cultivationã€€^ffffffMaster of Harmony
Summon an elemental spirit of thunder to protect you. The Storm
Mistress attacks your enemies, dealing Metal damage, and lasts for ^96f5ff50^ffffff seconds. You can
use Energy Leech to draw power from your Storm Mistress and weapons
from friendly targets within ^96f5ff15^ffffff meters to increase
your Magic Defense by ^96f5ff100%%^ffffff and your Magic Attack by ^96f5ff200%%^ffffff for ^96f5ff20^ffffff seconds.
These effects are acquired immediately when the pet is born.

^a6caf0You can use Transference to increase the duration of Storm Mistress.

^f7dfa5Sage version reduces the Mana cost by ^96f5ff10%%^f7dfa5.
^f7dfa5Grants the Storm Mistress the ^96f5ffMoonshade^f7dfa5 skill."*/
...
#ifdef _SKILL_CLIENT
            name                = L"Ðþ¡¤Ä§ÉñÏÖÊÀ";
            nativename          = "Ðþ¡¤Ä§ÉñÏÖÊÀ";
            icon                = "½ð¹âµçÄ¸ÏÉ¼¼ÄÜ.dds";
#endif
            max_level           = 1;
            type                = 2;
            apcost              = 0;
