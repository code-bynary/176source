...
/*
22510  "Î£Sacrificial Slash"22511  "^ffff00Î£Sacrificial Slash
...
Abandon your defensive maneuvers and go completely
on the offensive, reducing your
Defense Level by ^96f5ff60%%^ffffff and
increasing your Attack level by
^96f5ff60%%^ffffff of the Defense Level reduction.
Lasts ^96f5ff15^ffffff seconds. Reduces your
Defense Level by a minimum of ^96f5ff30^ffffff."*/
...
namespace GNET
{
    ...
    class Skill2251Stub:public SkillStub
    {
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (skill->GetT0 () * 0.37);
