...
Let out a furious roar that causes all enemies within ^96f5ff20^ffffff
meters to attack you. If the target is a player, it will be forced to target
you for ^96f5ff8^ffffff seconds.

^96f5ffA player hit by Roar will not be affected by this effect
in the next 60 seconds.

^f7dfa5Sage version rattles enemies for ^96f5ff10^f7dfa5 seconds, reducing their Magic Attack by ^96f5ff30%%^f7dfa5 of gear value."*/
...
namespace GNET
{
    ...
    class Skill534Stub:public SkillStub
    {
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetForceselecttargetRoar (1);
            skill->GetVictim ()->SetProbability (1.0 * 100);
            skill->GetVictim ()->SetTime (60000);
            skill->GetVictim ()->SetImmuneRoar (1);
            return true;
        }
#endif
#ifdef _SKILL_SERVER
