...
/*
37650  "Î¨Crush Vigor"37651  "^ff5c00Î¨Crush Vigor
...
Curse the target with forgetfulness for ^96f5ff15^ffffff seconds, causing it to lose ^96f5ff20^ffffff Chi whenever it is attacked.

^a6caf0If the enemy is already cursed, the previous curse will be removed.

^00ffffEthereal Glyph Effect:^00ffff@1
