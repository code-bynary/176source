...
/*
12460  "â—Red Tide"12461  "^8080ffâ—Red Tide

^ffcb4aRange ã€€^96f5ff28.5^ffffffã€€^ffcb4a meters
^ffcb4aManaã€€^96f5ff680^ffffff
^ffcb4aChannelã€€^ffffff1.8ã€€^ffcb4a seconds
...
^f7dfa5Sage version has a ^96f5ff50%%^f7dfa5 chance to only cost 1 Spark."*/
