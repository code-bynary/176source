...
/*
62310  "Î¨ Bestial Onslaught"62311  "^ff5c00 Î¨ Bestial Onslaught
...
^96f5ff5516^ffffff physical damage. Distracts the target for ^96f5ff8^ffffffseconds,
reducing their Evasion by ^96f5ff50%%^ffffff. In ^96f5ff6^ffffffseconds, increases your Critical Hit Rate by ^96f5ff40%%^ffffff.
Guaranteed critical hits within ^96f5ff6^ffffff seconds.

^f7dfa5Never misses.

^ffcb4aGolden Glyph Effect:@1
^ffcb4aLv1-4: Deals an additional ^96f5ff60%%^ffcb4a of weapon damage
^ffcb4aLv5-7: Deals an additional ^96f5ff80%%^ffcb4a of weapon damage
^ffcb4aLv8-9: Deals an additional ^96f5ff100%%^ffcb4a of weapon damage
^ffcb4a Lv 10: Deals an additional ^96f5ff120%%^ffcb4a of weapon damage@1@2
...
#ifdef _SKILL_CLIENT
            name                = L"Éñ¡¤ÊÞÍõÎÞµÐ";
            nativename          = "Éñ¡¤ÊÞÍõÎÞµÐ";
            icon                = "Éñ¡¤ÊÞÍõÎÞµÐ»Æ.dds";
#endif
            max_level           = 1;
            type                = 1;
            apcost              = 0;
