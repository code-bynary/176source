...
/*
44530  "Î¨Toxic Torrent"44531  "^ff5c00Î¨Toxic Torrent
...
^00ff00Lv1-4: Increases poison damage to ^96f5ff360%%^00ff00 of weapon damage.
^00ff00Lv5-7: Increases poison damage to ^96f5ff540%%^00ff00 of weapon damage.
^00ff00Lv8-9: Increases poison damage to ^96f5ff720%%^00ff00 of weapon damage.
^00ff00Lv10: Increases poison damage to ^96f5ff900%%^00ff00 of weapon damage.@1@2
Increases poison damage to ^96f5ff%d%%^00ff00 of weapon damage.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        class State2:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 3.6, 5.4, 7.2, 9);
        ...
        {
            float _glyph_value = get_glyph(player->GetSkilllevel (4453), 3.6, 5.4, 7.2, 9);
