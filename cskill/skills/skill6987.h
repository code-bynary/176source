...
/*
69870  "Î¨Tidal Mind"69871  "^ff5c00Î¨Tidal Mind
...
^ffcb4aLv1-4: Obtains ^96f5ff1^ffcb4a Hit Charge.
^ffcb4aLv5-7: Obtains ^96f5ff2^ffcb4a Hit Charges.
^ffcb4aLv8-9: Obtains ^96f5ff3^ffcb4a Hit Charges.
^ffcb4aLv10: Obtains ^96f5ff4^ffcb4a Hit Charges.@1@2
Obtains ^96f5ff%d^ffcb4a Hit Charges.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        Skill6987Stub ():SkillStub (6987)
        {
            cls                 = 5;
#ifdef _SKILL_CLIENT
            name                = L"Éñ¡¤ÈýÊÀÂÖÓ¡Öä";
            nativename          = "Éñ¡¤ÈýÊÀÂÖÓ¡Öä";
            icon                = "ÈýÊÀÂÖÓ¡ÖäÉñ»Æ.dds";
#endif
            max_level           = 1;
            type                = 2;
            apcost              = 0;
