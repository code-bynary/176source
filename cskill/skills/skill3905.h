...
/*
39050  "Î¨Ocean's Edge"39051  "^ff5c00Î¨Ocean's Edge
...
For every ^96f5ff100^ff0000Chi spent, deals ^96f5ff%d%%^ff0000 of weapon damage.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        class State2:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetRatio (skill->GetPlayer ()->GetCurweapon () == 5 ? (1.5 + _res) : skill->GetPlayer ()->GetCurweapon () == 1 ? (3.1 + _res) : _res );
                //printf("ratio: %f \n", (1.0 * skill->GetRatio()));
