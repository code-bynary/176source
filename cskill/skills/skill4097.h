...
/*
40970  "Î¨Galemark"40971  "^ff5c00Î¨Galemark
...
^00ffffLv5-7: Deals an additional ^ffffff110%%^00ffff of weapon damage.
^00ffffLv8-9: Deals an additional ^ffffff140%%^00ffff of weapon damage.
^00ffffLv10: Deals an additional ^ffffff170%%^00ffff of weapon damage.@1@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        class State2:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (4270);
                skill->SetRatio (0.5 + (skill->GetRand() > 50 ? _glyph_value : 0));
