...
/*
38130  "ΨTackling Slash"38131  "^ff5c00ΨTackling Slash
...
^00ff00Lv1-4: Deals an additional ^96f5ff120%%^00ff00 of weapon damage plus ^96f5ff1430^00ff00.
Each Hit Charge increases damage by ^96f5ff40%%^00ff00 of weapon damage.
^00ff00Lv5-7: Deals an additional ^96f5ff180%%^00ff00 of weapon damage plus ^96f5ff2145^00ff00.
Each Hit Charge increases damage by ^96f5ff60%%^00ff00 of weapon damage.
^00ff00Lv8-9: Deals an additional ^96f5ff240%%^00ff00 of weapon damage plus ^96f5ff2860^00ff00.
Each Hit Charge increases damage by ^96f5ff80%%^00ff00 of weapon damage.
^00ff00Lv10: Deals an additional ^96f5ff300%%^00ff00 of weapon damage plus ^96f5ff3575^00ff00.
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        class State2:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                ...
                float _glyph_plus_from_charge = get_glyph(skill->GetLevel (), 0.4, 0.6, 0.8, 1);
