...
/*
44280  "Î¨Rewinding Gesture"44281  "^ff5c00Î¨Rewinding Gesture
...
resetting the cooldowns of Voidstep and Unfetter. Has a
^96f5ff10%%^ffffff chance to reset the cooldown of Î¨Rewinding Gesture.
Also increases your Critical Rate by ^96f5ff15%%^ffffff for ^96f5ff12^ffffff seconds.

^ff0000Sanguine Glyph Effect:@1^ff0000
^ff0000Lv1-4: Has a ^96f5ff20%%^ff0000 to reset the cooldown of Î¨Rewinding Gesture.
^ff0000Lv5-7: Has a ^96f5ff30%%^ff0000 to reset the cooldown of Î¨Rewinding Gesture.
^ff0000Lv8-9: Has a ^96f5ff40%%^ff0000 to reset the cooldown of Î¨Rewinding Gesture.
^ff0000Lv10: Has a ^96f5ff50%%^ff0000 to reset the cooldown of Î¨Rewinding Gesture.@1@2
^ff0000Has a ^96f5ff%d%%^ff0000 to reset the cooldown of Î¨Rewinding Gesture.@2
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetNewValue2(skill->GetRand () <= _glyph_value ? 4428 : 0);
