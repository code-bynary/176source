...
/*
34650  "Î¨Moonblade"34651  "^ff5c00Î¨Moonbladeã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€

^ffcb4aRangeã€€^96f5ff27^ffffffã€€^ffcb4ameters
^ffcb4aManaã€€^96f5ff276^ffffff
^ffcb4aChannelã€€^ffffff1.1^ffcb4aã€€ã€€seconds
...
With ^ffffff3 Thunder Charges^00ffff, you have a ^ffffff100%%^00ffff chance to trigger the first attack effect.
^00ffffLv1-4: With ^ffffff3 Thunder Charges^00ffff, ^00ffffthe chance to trigger the fourth healing effect is increased to ^ffffff35%%.
^00ffffLv5-7: With ^ffffff3 Thunder Charges^00ffff, ^00ffffthe chance to trigger the fourth healing effect is increased to ^ffffff40%%.
^00ffffLv8-9: With ^ffffff3 Thunder Charges^00ffff, ^00ffffthe chance to trigger the fourth healing effect is increased to ^ffffff45%%.
^00ffffLv10: With ^ffffff3 Thunder Charges^00ffff, ^00ffffthe chance to trigger the fourth healing effect is increased to ^ffffff50%%.@1@2
With ^ffffff3 Thunder Charges^00ffff, You have a ^ffffff100%%^00ffff chance to trigger the first attack effect and
a ^ffffff%d%%^00ffff chance to trigger the fourth healing effect.@2"0  "chance"0  "trigger"0  "fourth"0  "effect.@2""0  "chance"0  "trigger"0  "fourth"0  "effect.@2"0  "chance""0  "trigger"0  "fourth"0  "effect.@2"0  "chance"0  "trigger""0  "fourth"0  "effect.@2"0  "chance"0  "trigger"0  "fourth""0  "effect.@2"0  "chance"0  "trigger"0  "fourth"0  "effect.@2""0  "chance"0  "trigger"0  "fourth"0  "effect.@2"0  "chance""0  "trigger"0  "fourth"0  "effect.@2"0  "chance"0  "trigger""0  "fourth"0  "effect.@2"0  "chance"0  "trigger"0  "fourth""0  "effect.@2"0  "chance"0  "trigger"0  "fourth"0  "effect.@2""0  "chance"0  "trigger"0  "fourth"0  "effect.@2"0  "chance""0  "trigger"0  "fourth"0  "effect.@2"0  "chance"0  "trigger""0  "fourth"0  "effect.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * skill->GetSection () == 1 ? skill->GetT0() == 1 ? 100 : skill->GetPerformerCurBalls() == 15 ? 100 : 0 : 0);
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * skill->GetSection () == 4 ? skill->GetT1 () == 15 ? 100 : _glyph_value : 0);
