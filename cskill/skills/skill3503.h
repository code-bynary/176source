...
/*
35030  "Î¨Aim Low"35031  "^ff5c00Î¨Aim Low
...
Charge your weapon for up to ^96f5ff1.5 ^ffeaabseconds to increase the Silence duration.
^ffeaabLv1-4: Silences the target for up to ^96f5ff2.5 ^ffeaabseconds.
^ffeaabLv5-7: Silences the target for up to ^96f5ff3.3 ^ffeaabseconds.
^ffeaabLv8-9: Silences the target for up to ^96f5ff4.0 ^ffeaabseconds.
^ffeaabLv10: Silences the target for up to ^96f5ff4.8 ^ffeaabseconds.@1@2
Charge your weapon for up to ^96f5ff1.5 ^ffeaabseconds, Silences the target for up to ^96f5ff%.1f ^ffeaabseconds.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetProbability (1.0 * 100);
            skill->GetVictim ()->SetTime (2100 + (skill->GetT0 () >= 1500 ? _glyph_value : 0));
