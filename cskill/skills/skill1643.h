...
/*
16430  "â—‹Energy Leech"16431  "^8080ffâ—‹Energy Leech
...
Draw power from your summoned creature,
unsummoning it to empower yourself.
Specific effects are based on the
summoned creature. Cannot be interrupted
by stun or freeze effects. Lasts ^96f5ff6^ffffff seconds.

^a6caf0Costs ^ffffff1^a6caf0 Spark.

^d618e7Demon version has a ^96f5ff50%%^d618e7 chance to increase your speed by ^96f5ff60%%^d618e7 for ^96f5ff10^d618e7 seconds."*/
...
#ifdef _SKILL_CLIENT
            name                = L"¿ñ¡¤ÍµÌì»»ÈÕ";
            nativename          = "¿ñ¡¤ÍµÌì»»ÈÕ";
            icon                = "Í¬ÆøÁ¬Ö¦Ä§¼¼ÄÜ.dds";
#endif
            max_level           = 1;
            type                = 2;
            apcost              = 100;
