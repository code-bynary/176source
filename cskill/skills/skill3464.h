...
/*
34640  "Î¨Moonblade"34641  "^ff5c00Î¨Moonbladeã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€ã€€
...
^00ff00Lv1-4: When not in Reaper Form, the chance to trigger the effects is increased to ^96f5ff35%%.
^00ff00Lv5-7: When not in Reaper Form, the chance to trigger the effects is increased to ^96f5ff40%%.
^00ff00Lv8-9: When not in Reaper Form, the chance to trigger the effects is increased to ^96f5ff45%%.
^00ff00Lv10: When not in Reaper Form, the chance to trigger the effects is increased to ^96f5ff50%%.@1@2
^00ff00When not in Reaper Form, the chance to trigger the effects is increased to ^96f5ff%d%%.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetT0 () == 1 ?
            skill->GetT1 () == 2 ? 100 :
            skill->GetT1 () == 7 ? 100 : _glyph_value : _glyph_value : 0);
