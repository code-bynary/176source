...
/*
16950  "â—‹Quid Pro Quo"16951  "^8080ffâ—‹Quid Pro Quo
...
^ffcb4aCooldownã€€^ffffff30  ^ffcb4a seconds
...
status effects from yourself to your target, and silencing the target for ^96f5ff1^ffffff second.

^d618e7Demon version also immobilizes the target for ^96f5ff2^d618e7 seconds."*/
...
#ifdef _SKILL_CLIENT
            name                = L"¿ñ¡¤ÉíÍâ»¯Éí";
            nativename          = "¿ñ¡¤ÉíÍâ»¯Éí";
            icon                = "ÉíÍâ»¯ÉíÄ§¼¼ÄÜ.dds";
#endif
            max_level           = 1;
            type                = 3;
            apcost              = 0;
