...
/*
34430  "Î¨Downburst"34431  "^ff5c00Î¨Downburst
...
^ffcb4aCooldownã€€^ffffff1.0^ffcb4aã€€second
...
rain, dealing ^96f5ff90%%^ffffff of base magic damage plus ^96f5ff120%%^ffffff of weapon
damage plus ^96f5ff3580^ffffff as Water damage. Reduces your channeling
time by ^96f5ff25%%^ffffff for ^96f5ff6^ffffff seconds. Generates an Ice Charge.
^96f5ffWhile in Reaper Form, damage is increased by ^ffffff33%%.

^ffa4a9Can cast while moving.

^ffeaabArgent Glyph Effect:@1
^ffeaabLv1-4: While in Reaper Form, damage is increased by ^96f5ff39.0%%.
^ffeaabLv5-7: While in Reaper Form, damage is increased by ^96f5ff44.5%%.
^ffeaabLv8-9: While in Reaper Form, damage is increased by ^96f5ff50.0%%.
^ffeaabLv10: While in Reaper Form, damage is increased by ^96f5ff55.5%%.@1@2
^ffeaabWhile in Reaper Form, damage is increased by ^96f5ff%.1f%%.@2"*/
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax;
        ...
        class State2:public SkillStub::State
        {
            ...
            void Calculate (Skill * skill) const
            {
                float _glyph_value = get_glyph(skill->GetLevel (), 1.39, 1.45, 1.5, 1.55);
                
                skill->GetPlayer ()->SetDecmp (160);
                skill->SetPlus (3580);
                skill->SetRatio (1.2);
                skill->GetPlayer ()->SetAddball (1);
                skill->SetWaterdamage ((skill->GetPlayer ()->GetForm () == 1 ? _glyph_value : 0.9) * skill->GetMagicattack ());
