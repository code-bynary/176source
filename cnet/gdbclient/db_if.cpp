...
namespace GDB
{
	...
	bool LoadNewRoleDetail(const GNET::GNewRoleDetail & pRole, vecdata_new & data)
	{
		...
		NewLoad( data.rank              	 , pRole.rank             		);
		NewLoad( data.newhistory             , pRole.newhistory        		);
		NewLoad( data.question_data          , pRole.question_data        	);
		NewLoad( data.arena_team       		 , pRole.arena_team      		);
		NewLoad( data.storage_back       	 , pRole.storage_back 		    );
		NewLoad( data.association       	 , pRole.association 		    );
	...
	bool SaveNewRoleDetail(GNET::GNewRoleDetail & pRole, const vecdata_new & data)
	{
		...
		NewSave( data.rank              	 , pRole.rank	                );
		NewSave( data.newhistory             , pRole.newhistory	            );
		NewSave( data.question_data          , pRole.question_data	        );
		NewSave( data.arena_team       		 , pRole.arena_team      		);
		NewSave( data.storage_back       	 , pRole.storage_back 		    );
		NewSave( data.association       	 , pRole.association 		    );	
