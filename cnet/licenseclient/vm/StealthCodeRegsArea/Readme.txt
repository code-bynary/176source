...
1) Include "StealthCodeArea.h" in one of your source code files. Notice that you can instead use "StealthCodeArea_Max.h" if your compiler works faster with it.
...
3) The "STEALTH_REGS_AREA" allocates space in your data section where the Virtual Machine registers will be placed

4) Create a function *which is never executed* and insert there 
...
//
// Here is the function which contains the Stealth Code area
//
