...
namespace S2C
{
	...
	enum		//CMD
	{
		...
		ASSOCIATION_PLAYER_INFO,
		ASSOCIATION_PVP_MODE,
		ASSOCIATION_PLAYER_LEVEL_UP,
		ASSOCIATION_TASK_INFO, // Reserved
		PET_SKILL_DATA,
	...
	enum //main packets  
	{
		...
		NEW_ARENA_PLAYERS_ALIVE = 12704,
		NEW_ARENA_RELOGIN_REQUEST = 12705,
		NEW_ARENA_GET_OPEN = 12706,
		NEW_ARENA_TEAM_REWARD = 12707,
