...
namespace S2C
{
	enum
	{
		...
		ASSOCIATION_BEGIN = 542,								  //"Begin"
		ASSOCIATION_CONNECTION_FAILED,							  //"A conexão falhou. Não é possível se conectar com outros personagens da mesma conta."
		ASSOCIATION_INCORRECT_ACTION,							  //"Ação de Associação incorreta"
		ASSOCIATION_PERSONAL_ACTION_ON_HOLD,					  //"Ação de Associação Pessoal está em espera"
		ASSOCIATION_CLAN_DIFFERENT,							  //"Associação do Clã é diferente da Associação do jogador"
		ASSOCIATION_TOO_MANY_PLAYERS,							  //"Muitos jogadores na Associação selecionada. Tente novamente mais tarde."
		ASSOCIATION_CLAN_JOINING,								  //"O Clã está se juntando à Associação. Tente juntar-se à Associação com seu personagem mais tarde."
		ASSOCIATION_INCORRECT_PARAMETER,						  //"Parâmetro de Associação incorreto"
		ASSOCIATION_NOT_IN_CLAN,								  //"Você não está em um Clã"
		ASSOCIATION_INCORRECT_RANK_TYPE,						  //"Tipo de Classificação incorreto"
		ASSOCIATION_INSUFFICIENT_ITEMS,						  //"Itens insuficientes"
		ASSOCIATION_JOINED_IMPERIAL_ANNIHILATORS,				  //"Você entrou nos Aniquiladores Imperiais"
		ASSOCIATION_JOINED_DIVINE_DEFENDERS,					  //"Você entrou nos Defensores Divinos"
		ASSOCIATION_LEFT,										  //"Você saiu da Associação"
		ASSOCIATION_CLAN_JOINED,								  //"Seu Clã juntou-se à Associação"
		ASSOCIATION_DID_NOT_WAIT_2_MINUTES,					  //"Você não esperou 2 minutos após submeter uma aplicação ou o Clã falhou em juntar-se à Associação"
		ASSOCIATION_LEVEL_TOO_LOW,								  //"Seu nível é muito baixo"
		ASSOCIATION_CANNOT_TEAM_WITH_OPPOSITE,				  //"Você não pode formar uma equipe com um jogador na Associação oposta"
		ASSOCIATION_FAILED_TO_ADD_MATERIALS,					  //"Falhou ao adicionar Materiais"
		ASSOCIATION_MATERIALS_ADDED,							  //"Materiais foram adicionados"
		ASSOCIATION_RANKING_UPDATE_ON_HOLD,					  //"A Atualização do Ranking está em espera."
		ASSOCIATION_CLAN_JOIN_APPLICATION_SENT,				  //"Uma aplicação para seu Clã juntar-se à Associação foi enviada. Por favor, aguarde 2 minutos."
		ASSOCIATION_CLAN_CHANGE_APPLICATION_SENT,				  //"Uma aplicação para seu Clã trocar de Associação foi enviada. Por favor, aguarde 2 minutos."
		ASSOCIATION_COMBAT_LEVEL_TOO_LOW,						  //"Seu Nível de Combate é muito baixo. Não pode forjar."
		ASSOCIATION_INSUFFICIENT_GOLDEN_BLADE_SYMBOLS,		  //"Símbolos da Lâmina Dourada insuficientes. Falha ao comprar."
		ASSOCIATION_NON_MATCHING,								  //"Associações não correspondentes"
		ASSOCIATION_HORN_CANNOT_BE_USED_CROSS_SERVER,			  //"O chifre não pode ser usado no interservidor"
		ASSOCIATION_WAIT_30_SECONDS_AFTER_MAP_CHANGE,			  //"Por favor, aguarde 30 segundos após entrar ou sair do mapa do interservidor para usar essa função"
		ASSOCIATION_SWITCH_COOLDOWN_RESET,					  //"Tempo de Espera para Troca de Associação foi reiniciado"
		ASSOCIATION_FAILED_TO_RESET_SWITCH_COOLDOWN,			  //"Falha ao reiniciar o Tempo de Espera para Troca de Associação. O item não será gasto"
